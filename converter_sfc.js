...
const ARQUIVO_TXT = path.join(__dirname, 'src/app/data/importar/questoes_sfc.txt');
const ARQUIVO_JSON = path.join(__dirname, 'src/app/data/SFC.json');
...
console.log(`SFC convertido com sucesso: ${questoes.length} questões salvas em ${ARQUIVO_JSON}`);
